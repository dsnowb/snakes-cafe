...
def test_multi_add_to_cart(cur):
    """Tests that items that are in the menu and in the cart are incremented in the test_remove_cart"""
...
def test_remove_cart_multi(cur):
    """Tests that if more than one of an item is in the cart, multi will remove specified count"""
...
def test_remove_cart_multi_valid(cur):
    """Tests that if more than the number of items in the cart are attempted to be removed, the remove fails"""
